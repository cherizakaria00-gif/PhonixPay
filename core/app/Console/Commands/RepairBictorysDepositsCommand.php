...
class RepairBictorysDepositsCommand extends Command
{
    protected $signature = 'bictorys:repair
        ...
        {--max-charge-lookups=60 : Maximum charge lookups per gateway}
    ...
    protected $description = 'Reconcile stuck Bictorys deposits (initiated/pending) to success or rejected.';
