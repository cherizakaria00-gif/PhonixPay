...
class GeneralSettingController extends Controller
{
    ...
    public function generalUpdate(Request $request)
    {
        ...
        $general->api_prefix = $request->api_prefix;
        $general->api_test_prefix = $request->api_test_prefix;
        $general->payment_fixed_charge = $request->payment_fixed_charge;
        $general->payment_percent_charge = $request->payment_percent_charge;
