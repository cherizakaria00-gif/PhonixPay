                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="any" name="payment_fixed_charge" class="form-control" value="{{ getAmount($user->payment_fixed_charge) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="any" name="payment_percent_charge" class="form-control" value="{{ getAmount($user->payment_percent_charge) }}">
