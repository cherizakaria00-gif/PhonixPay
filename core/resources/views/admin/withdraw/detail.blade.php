                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="fw-bold">1 {{__(gs('cur_text'))}}
                                = {{ showAmount($withdrawal->rate, currencyFormat:false) }} {{__($withdrawal->currency)}}</span>
                        </li>

                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Payable')
                            <span class="fw-bold">{{ showAmount($withdrawal->final_amount, currencyFormat:false) }} {{__($withdrawal->currency)}}</span>
                        </li>
