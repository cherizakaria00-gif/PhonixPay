        ...
        <main>
            ...
            <section class="pb-16">
                <div class="mx-auto max-w-6xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    ...
                    <div>
                        <p class="text-[#9ad8bf] text-sm font-semibold">{{ __(@$about->heading) }}</p>
            ...
            <section class="py-16 bg-slate-900/60">
                <div class="mx-auto max-w-6xl px-6">
                    <div class="text-center mb-10">
                        <p class="text-[#9ad8bf] text-sm font-semibold">{{ __(@$paymentSolution->heading) }}</p>
            ...
            <section class="py-16 bg-slate-900/60">
                <div class="mx-auto max-w-6xl px-6 grid grid-cols-1 lg:grid-cols-3 gap-10">
                    <div class="lg:col-span-1">
                        <p class="text-[#9ad8bf] text-sm font-semibold">{{ __(@$developer->heading) }}</p>
            ...
            <section class="pb-16">
                <div class="mx-auto max-w-6xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    ...
                    <div>
                        <p class="text-[#9ad8bf] text-sm font-semibold">{{ __(@$mission->heading) }}</p>
                        ...
                        @if(!empty($mission->button_text))
                            <a href="{{ @$mission->button_url }}" class="mt-6 inline-flex items-center gap-2 rounded-full bg-[#87c5a6] px-5 py-2 text-sm font-semibold text-white shadow-md transition hover:bg-[#9ad8bf]">
            ...
            <section class="py-16 bg-slate-900/60">
                <div class="mx-auto max-w-6xl px-6">
                    <div class="text-center mb-10">
                        <p class="text-[#9ad8bf] text-sm font-semibold">{{ __(@$feature->heading) }}</p>
            ...
            <section class="py-16">
                <div class="mx-auto max-w-6xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    <div>
                        <p class="text-[#9ad8bf] text-sm font-semibold">{{ __(@$payout->heading) }}</p>
            ...
            <section class="py-16">
                <div class="mx-auto max-w-4xl px-6">
                    <div class="text-center mb-8">
                        <p class="text-[#9ad8bf] text-sm font-semibold">{{ __(@$faq->heading) }}</p>
