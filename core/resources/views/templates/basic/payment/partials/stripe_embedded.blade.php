<div class="payment-modal">
    ...
    <div class="modal">
        ...
        <form class="form appPayment" id="stripe-embedded-form" method="{{ $data->method }}" action="{{ $data->url }}">
            @csrf
            ...
            <div class="separator">
                <hr class="line" />
                <p>@lang('or pay using credit card')</p>
                <hr class="line" />
            </div>
            <div class="credit-card-info--form">
                <div class="input_container">
                    <label class="input_label" for="stripe-card-name">@lang('Card holder full name')</label>
                    <input
                ...
                <div class="input_container">
                    <label class="input_label" for="stripe-card-number">@lang('Card Number')</label>
                    <input
                ...
                <div class="input_container">
                    <label class="input_label" for="stripe-card-expiry">@lang('Expiry Date / CVV')</label>
                    <div class="split">
                        <input
                            placeholder="01/23"
                            name="cardExpiry"
                ...
                <button class="purchase--btn" type="submit">@lang('Checkout')</button>
            </div>
        </form>
    </div>
</div>
