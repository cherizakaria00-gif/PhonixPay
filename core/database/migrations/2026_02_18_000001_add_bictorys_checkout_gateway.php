...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $exists = DB::table('gateways')->where('alias', 'BictorysCheckout')->exists();
        if ($exists) {
            return;
        }
        ...
        DB::table('gateways')->insert([
            'form_id' => 0,
            'code' => 127,
            'name' => 'Bictorys Checkout',
            'alias' => 'BictorysCheckout',
    ...
    public function down(): void
    {
        ...
        DB::table('gateways')->where('alias', 'BictorysCheckout')->delete();
    }
};
