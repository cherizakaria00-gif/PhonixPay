    ...
    public function up(): void
    {
        ...
        $pages = [
            [
                ...
                'details' => <<<'HTML'
<p>FlujiPay (“FlujiPay”, “we”, “us”, “our”) provides payment services at flujipay.com. This Privacy Policy explains how we collect, use, share, and protect information when you use our services.</p>
...
<ul>
    <li>Provide, operate, and improve the FlujiPay services.</li>
...
<h4>Contact Us</h4>
<p>If you have questions about this Privacy Policy, contact FlujiPay support via flujipay.com.</p>
HTML,
            ],
            [
                ...
                'details' => <<<'HTML'
<p>These Terms of Service govern your use of FlujiPay and the services available at flujipay.com. By using our services, you agree to these terms.</p>

<h4>Eligibility</h4>
<p>You must be legally able to enter into a contract and comply with all applicable laws to use FlujiPay.</p>
...
<p>FlujiPay enables merchants to accept payments from customers. We may update or discontinue features to maintain security and compliance.</p>
...
<h4>Compliance</h4>
<p>You must comply with AML, sanctions, and consumer protection laws. FlujiPay may request additional documentation to meet regulatory requirements.</p>

<h4>Intellectual Property</h4>
<p>All platform content, branding, and software are owned by FlujiPay or its licensors.</p>
...
<p>Services are provided “as is” to the extent permitted by law. FlujiPay is not liable for indirect or consequential damages.</p>

<h4>Governing Law</h4>
<p>These terms are governed by applicable laws in the jurisdictions where FlujiPay operates.</p>
HTML,
            ],
            [
                ...
                'details' => <<<'HTML'
<p>These Terms & Conditions apply to your access and use of the FlujiPay website and any related content at flujipay.com.</p>
...
<p>Our website may contain links to third-party sites. FlujiPay is not responsible for their content or practices.</p>
...
<h4>Contact</h4>
<p>For questions about these Terms & Conditions, visit flujipay.com and contact our support team.</p>
HTML,
            ],
            [
                'slug' => 'aml-policy',
                'title' => 'AML Policy',
                'details' => <<<'HTML'
<p>FlujiPay maintains a robust Anti-Money Laundering (AML) program designed to prevent the misuse of our services for illicit activities.</p>
...
<h4>Contact</h4>
<p>For AML inquiries, contact FlujiPay via flujipay.com.</p>
HTML,
            ],
            [
                'slug' => 'pci-dss',
                ...
                'details' => <<<'HTML'
<p>FlujiPay is committed to protecting cardholder data and maintaining strong security practices aligned with the PCI DSS (Payment Card Industry Data Security Standard).</p>

<h4>Secure Processing</h4>
<p>Card data is processed using PCI DSS-compliant service providers and secure encryption protocols.</p>

<h4>Data Minimization</h4>
<p>FlujiPay does not store full card numbers or sensitive authentication data on our servers.</p>
...
<h4>Contact</h4>
<p>For PCI DSS compliance inquiries, contact FlujiPay via flujipay.com.</p>
HTML,
            ],
        ];
