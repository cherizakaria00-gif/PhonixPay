...
Route::middleware('admin')->group(function () {
    ...
    // Users Manager
    Route::controller('ManageUsersController')->name('users.')->prefix('merchants')->group(function(){
    ...
    Route::controller('DepositController')->prefix('deposit')->name('deposit.')->group(function(){
        ...
        Route::get('canceled/{user_id?}', 'rejected')->name('rejected');
    ...
    Route::controller('ReportController')->prefix('report')->name('report.')->group(function(){
     ...
     //Payment Statistics 
    Route::controller('PaymentStatisticsController')->name('payment.')->prefix('payment/statistics')->group(function(){
        Route::get('/','index')->name('index');  
        Route::get('/statistics','statistics')->name('statistics');
        Route::get('payment-charge-chart','paymentCharge')->name('charge');
    });
